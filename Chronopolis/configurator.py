...
def setup_llm_backend():
    ...
    if _CAN_WRITE_TOML:
        _write_toml_file(BASE_DIR / "Chronopolis" / "config.toml", cfg)
...
def _manage_interface_plugins():
    ifaces_dir = BASE_DIR / "body" / "interfaces"
...
def manage_personas():
    ...
    personas_dir = BASE_DIR / "soul" / "personas"
    ...
    # Actions
    all_actions     = _list_plugins(BASE_DIR / "body" / "actions")
    ...
    # Interfaces
    all_ifaces     = _list_plugins(BASE_DIR / "body" / "interfaces")
...
def import_persona():
    ...
    persona_dir = BASE_DIR / "soul" / "personas" / safe_name
...
def _load_config_toml() -> dict:
    p = BASE_DIR / "Chronopolis" / "config.toml"
